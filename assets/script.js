	...
	document.querySelectorAll(".fancy").forEach((element) => {
		...
		element.addEventListener("mouseenter", () => {
			outers.forEach((outer) => {
				const tx =
					Math.random() * movementsOfLetters.leftAndRight * 2 -
					movementsOfLetters.leftAndRight;
				const ty =
					Math.random() * movementsOfLetters.upAndDown * 2 -
					movementsOfLetters.upAndDown;
				const rot =
					Math.random() * movementsOfLetters.rotation * 2 -
					movementsOfLetters.rotation;
